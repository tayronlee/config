...
#prompt
color_none="\[\033[00m\]"
color_green="\[\033[01;36m\]"
PS1="${debian_chroot:+($debian_chroot)}\u${color_green}@${color_none}"samir-"\h${color_green}[${color_none}\w${color_green}]${color_none}$ "
unset color_none color_green
...
export MY_IP=$(echo $SSH_CONNECTION | awk '{print $1}')
